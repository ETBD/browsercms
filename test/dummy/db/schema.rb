...
ActiveRecord::Schema.define(version: 20130924162315) do
  ...
  create_table "default_attachable_versions", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "original_record_id"
  ...
  create_table "default_attachables", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "version"
  ...
  create_table "has_many_attachment_versions", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "original_record_id"
  ...
  create_table "has_many_attachments", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "version"
  ...
  create_table "has_thumbnail_versions", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "original_record_id"
  ...
  create_table "has_thumbnails", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "version"
  ...
  create_table "non_attachable_block", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "version"
  ...
  create_table "non_attachable_block_versions", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "original_record_id"
  ...
  create_table "publishable_block_versions", force: :cascade do |t|
    t.string   "name"
    t.integer  "original_record_id"
    t.integer  "version"
    t.boolean  "published",          default: false
  ...
  create_table "publishable_blocks", force: :cascade do |t|
    t.string   "name"
    t.integer  "version"
    t.integer  "lock_version",  default: 0
    t.boolean  "published",     default: false
  ...
  create_table "publishables", force: :cascade do |t|
    t.string  "name"
    t.boolean "published", default: false
  end

  create_table "searchable_block_without_name_versions", force: :cascade do |t|
    t.string   "title"
    t.integer  "original_record_id"
    t.integer  "version"
    t.string   "name"
  ...
  create_table "searchable_block_without_names", force: :cascade do |t|
    t.string   "title"
    t.integer  "version"
    t.integer  "lock_version",  default: 0
    t.string   "name"
  ...
  create_table "searchable_content_block_parents", force: :cascade do |t|
    t.string "name"
  end

  create_table "searchable_content_block_versions", force: :cascade do |t|
    t.integer  "parent_id"
    t.integer  "original_record_id"
    t.integer  "version"
    t.string   "name"
  ...
  create_table "searchable_content_blocks", force: :cascade do |t|
    t.integer  "parent_id"
    t.integer  "version"
    t.integer  "lock_version",  default: 0
    t.string   "name"
  ...
  create_table "taggable_articles", force: :cascade do |t|
    t.string "name"
  end

  create_table "thing_attributes", force: :cascade do |t|
    t.integer "thing_id"
    t.string  "name"
    t.text    "value"
  end
  ...
  create_table "two_attachment_versions", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "original_record_id"
  ...
  create_table "two_attachments", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "version"
  ...
  create_table "unpublishables", force: :cascade do |t|
    t.string "name"
  end

  create_table "versioned_attachable_versions", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "original_record_id"
  ...
  create_table "versioned_attachables", force: :cascade do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "version"
  ...
  create_table "versioned_taggable_article_versions", force: :cascade do |t|
    t.string   "name"
    t.integer  "original_record_id"
    t.integer  "version"
    t.boolean  "published",          default: false
  ...
  create_table "versioned_taggable_articles", force: :cascade do |t|
    t.string   "name"
    t.integer  "version"
    t.integer  "lock_version",  default: 0
    t.boolean  "published",     default: false
